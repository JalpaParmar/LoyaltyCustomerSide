...
- (void)setSelectedIndexPath:(NSIndexPath *)indexPath {
	if (![_selectedIndexPath isEqual:indexPath]) {
        ...
        if([delegate respondsToSelector:@selector(easyTableView:selectedCell:atIndexPath:deSelectedCell:)])
        {
            [delegate easyTableView:self selectedCell:selectedCell atIndexPath:indexPath deSelectedCell:deselectedCell];
        }
