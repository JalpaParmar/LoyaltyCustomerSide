...
- (void)easyTableView:(EasyTableView *)easyTableView selectedCell:(UITableViewCell *)selectedCell atIndexPath:(NSIndexPath *)indexPath deSelectedCell:(UITableViewCell *)deSelectedCell;
